    ...
    <div class="custom-flex h-full">
        ...
        <div class="sidebar show h-full" style="position: relative;">
            ...
            <ul class="nav flex-column d-md-block collapse" id="sidebarMenu">
                <li class="nav-item">
                    <a class="nav-link active" href="./goal.html">
                        <img src="./assets/images/goal.png" alt="No Image" />
                        <span>Goal</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="./user-portal-profile.html">
            ...
            <div class="main-screen-content mt-4">
                ...
                <div class="row">
                    <div class="row mt-3 mb-3">
                        <div class="col" style="gap: 1rem;font-weight: 500;">
                            <span class="ml-3 mr-1 border text-center p-2" style="border-radius: 50%;">
                                <img src="./assets/images/calendar 1.png" style="width: 1rem; height: 1rem;" alt="" class="ml-1  mb-1">
                            </span>
                            <span class="ml-2">Active Goal From</span>  <span class="ml-3 d-sm-inline mt-3 d-block" id="dateSpan">01-02-2023 to 01-08-2023</span>
                        </div>
                </div>
                </div>
                <div class="row mt-3">
                    <div class="col-sm-12 col-lg-8 col-md-12">
                        <div class="card px-3" style="height: 68vh;">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="progress-bar-container">
                                                ...
                                                <div>
                                                    <button type="submit"
                                                        class="btn btn btn-outline-primary submit-outline-btn">Edit</button>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                    ...
                    <div class="col-sm-12 col-lg-4 col-md-12">
                        <div class="card">
                            <div class="card-body">
                                <h5>User Overview</h5>
                                <div id="pi-chart" style="height: 58vh;"></div>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="float-right mt-4 mx-auto">
                        <nav aria-label="Page navigation example ">
                          <ul class="pagination " style="position: fixed;bottom:2.5%;left:50%;"> 
                            <li class="page-item">
                              <a class="page-link head deactive" href="#">Prev</a>
                            </li>
                            <li class="page-item">
                              <a class="page-link links selected" href="#">1</a>
                            </li>
                            <li class="page-item">
                              <a class="page-link links" href="#">2</a>
                            </li>
                            <li class="page-item">
                              <a class="page-link links" href="#">3</a>
                            </li>
                            <li class="page-item">
                              <a class="page-link links" href="#">...</a>
                            </li>
                            <li class="page-item">
                              <a class="page-link links" href="#">10</a>
                            </li>
                            <li class="page-item">
                              <a class="page-link head" href="#">Next</a>
                            </li>
                          </ul>
                        </nav>
                    </div>
     ...
     <script>
       $(document).ready(function() {
         ...
         anychart.onDocumentReady(function() {
             // set the data
             var data = [
                 {x: "Completed", value: 60, color: "#03AF9F"},
                 {x: "Bonus", value: 10, color: "#DCFF07"},
