...
<style>
    ...
    .flatpickr-day.endRange.endRange {
        background-color: #1F95AF !important;
        border: 1px solid #1F95AF !important;
    }
    ...
    <div class="custom-flex h-full">
        ...
        <div class="main-screen">
            <div class="main-screen-content mt-4">
                <div class="heading">
                    <h1>
                        <button class="d-md-inline d-none" data-toggle="collapse" data-target="#collapseExample"
                            aria-expanded="false" aria-controls="collapseExample" id="sidebar-toggle1">&#9776;</button>
                        Reports
                    </h1>
                </div>
                <form action="{{ route('admin.report') }}" method="GET" class="">
                    <div class="row justify-content-end align-items-center mb-2 filters">
                        <div class="col-sm-4 col-md-4 col-lg-3 pr-0 col-12">
                            <h6 class="filters-head">Filters Goals Date</h3>
                        </div>
                        <div class="col-sm-4 col-md-4 col-xl-3 col-lg-3 p-0 dates col-7 ">
                            <div class="input-group date">
                                <input type="text" id="startDate" name="dateRange" placeholder="Select date"
                                    class="datepicker form-control custom text-center mx-2 rounded" value="">
                        ...
                        <div class="col-sm-3 col-md-3 col-xl-2 col-lg-3 p-0 ml-sm-2 mr-md-4">
                            <span class="input-group-addon">
                                <img src="assets/images/mygoal.png" alt="goal" class="mr-3">
                            </span>
                            <select name="completionPercent" class="custom-select text-center form-control input-element"
                                id="inputGroupSelect02 " style="color:#03AF9F;">
                                <option value="100" selected>100% and lower</option>
                                <option value="70">70% and lower</option>
                                <option value="50">50% and lower</option>
                                <option value="25">25% and lower</option>
                            </select>
                        </div>
                        <div class="col-auto p-0 ml-sm-2 mr-md-4">
                            <button type="submit" class="btn btn-sm text-light py-2 px-3" style="background:#03AF9F;">Apply</button>
                        </div>
                    </div>
                </form>
                <div class="row m-0 p-0">
                    <div class="col-12 margin" id="page-content">
                        <div class="card px-3" style="height: 70vh;">
                                            ...
                                            <tr>
                                                    ...
                                                    <div>
                                                        <div>
                                                            <p class="complete-percentage">
                                                                {{ $report->stats()['completed_percentage'] }}%
                                                                Completed </p>
                                                        </div>
                                                        <div class="progress w-13 position-relative">
                                                            ...
                                                            <div class="progress-bar" role="progressbar"
                                                                style="width: {{ $report->stats()['completed_percentage'] }}%;">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                                    <a class="btn btn-outline-primary"
                                                        href="{{ route('admin.reportInfo', [$report->id]) }}"
                                    ...
                                    @if ($reports->hasPages())
                                        ...
                                        @for ($i = 1; $i <= $reports->lastPage(); $i++)
                                            <li class="page-item"><a
                                                    class="page-link links {{ $reports->currentPage() == $i ? 'selected' : '' }}"
                                                    href="{{ $reports->url($i) }}">{{ $i }}</a>
                                            </li>
                                        @endfor
                                        @if ($reports->hasMorePages())
                                            <li class="page-item"><a class="page-link head"
                                                    href="{{ $reports->nextPageUrl() }}">Next</a></li>
                                        @else
                                            <li class="page-item"><a class="page-link head deactive"
                                                    href="#">Next</a></li>
                                        @endif
