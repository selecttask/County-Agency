    ...
    <div class="main-screen">
      <div class="main-screen-content mt-4">
        <div class="heading mb-5">
          <h1>
            <a class="btn btn-primary ml-3" style="padding: 0px; margin-right: 15px; margin-bottom: 5px;;" href="{{route('admin.goal')}}">
            ...
            </a>{{$user->first_name . ' ' . $user->last_name}}</h1>
        </div>
        <div class="row ml-2">
...
{{--                </tr>--}}
          ...
          <div class=" center row  w-100" style="margin-top: 38px;">
...
<script>
  $(document).ready(function() {
    ...
    anychart.onDocumentReady(function() {
        // set the data
        var data = [
            {x: "Completed", value: {{ $stats['completed_percentage'] }}, color: "#03AF9F"},
            {x: "Bonus", value: {{ $stats['bonus_percentage'] }}, color: "#DCFF07"},
            {x: "Incomplete", value: {{ $stats['incompleted_percentage'] }}, color: "#FFCE21"},
        ];
